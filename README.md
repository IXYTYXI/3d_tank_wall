...
在本机双击 `launch-cinematic.command` 可启动可选的 Forward+ 画质样板：环境遮蔽、体积雾、辉光与 ACES 色调映射。原来的 `launch.command` 仍使用兼容渲染器。Forward+ 已在 Apple M4 / Metal 上运行；其他 GPU 尚未实测。0.4.1 两端下载包均包含这些更新，默认兼容模式；Mac 包附高画质启动.command，Windows 包附 HighQuality.cmd。
...
[下载 0.4.1 Windows 64 位 ZIP](https://github.com/IXYTYXI/3d_tank_wall/releases/download/v0.4.1-preview/SteelFront-0.4.1-Windows-x64.zip) · [版本说明与 SHA-256](https://github.com/IXYTYXI/3d_tank_wall/releases/tag/v0.4.1-preview)
...
[下载 0.4.1 macOS 通用 DMG](https://github.com/IXYTYXI/3d_tank_wall/releases/download/v0.4.1-preview/SteelFront-0.4.1-macOS-universal.dmg) · [版本说明与 SHA-256](https://github.com/IXYTYXI/3d_tank_wall/releases/tag/v0.4.1-preview)
...
已在本机 Apple M4 / macOS 上运行与截图验证。macOS 独立安装包为 0.4.1 试玩版，采用 ad-hoc 签名，未公证。Windows 已交叉导出并检查资源，尚未实机验证；Linux 的导出和实机验证尚未进行；Android 和 iOS 后续再适配。
